...
export default function StreakSquad({ members }: { members?: Member[] }) {
  const sample: Member[] = [
    { id: "1", name: "Aisha Khan", joined: "2024-06-12", streakDays: 14, goal: 30 },
    { id: "2", name: "Ravi Patel", joined: "2025-01-03", streakDays: 9, goal: 30 },
    { id: "3", name: "Maya Rao", joined: "2023-11-20", streakDays: 21, goal: 30 },
  ]
  ...
  return (
    <div className="">
      <div className="mb-3 flex items-center justify-between">
        ...
        <div className="text-xs text-muted-foreground">Challenge participants</div>
      </div>
                ...
                <div className="mt-1 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="h-2 w-full overflow-hidden rounded-full bg-border">
                      <div className={cn("h-2 rounded-full bg-primary")} style={{ width: `${pct}%` }} />
                    </div>
                  </div>
                </div>
              </div>
