...
export default function PracticeFilters({ filters, onFiltersChange, onApplyFilters, isMobile = false }: PracticeFiltersProps) {
  ...
  const FilterContent = () => (
    <div className="flex flex-col h-full">
      {/* Saved Filters Section - Scrollable */}
      ...
      {/* Sticky Action Buttons - positioned after saved filters */}
      ...
      {/* Custom Filters Section - Scrollable */}
